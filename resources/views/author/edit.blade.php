@extends('home')
@section('body')
    <form class="form-horizontal" role="form" method="POST" action="{{ URL::to($prefix.'/edit')}}">
        {{ csrf_field() }}
        ...
        <div class="form-group{{ $errors->has('title') || $errors->has('academic_position') ? ' has-error' : '' }}">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="col-md-8">
                        <label class="radio-inline">
                            <input type="radio" name="title" value="1" required {{ $user->title == '1' ? "checked":"" }}> Dr.
                        </label>
                        <label class="radio-inline">
                            <input type="radio" name="title" value="2" required {{ $user->title == '2' ? "checked":"" }}> Mr.
                        </label>
                        <label class="radio-inline">
                            <input type="radio" name="title" value="3" required {{ $user->title == '3' ? "checked":"" }}> Ms.
                        </label>
                        <label class="radio-inline">
                            <input type="radio" name="title" value="4" required {{ $user->title == '4' ? "checked":"" }}> Mrs.
                        </label>
                ...
                <div class="col-md-6">
                    ...
                    <div class="col-md-8">
                        <label class="radio-inline">
                            <input type="radio" name="academic_position" value="1" required {{ $user->academic_position == '1' ? "checked":"" }}> Prof.
                        </label>
                        <label class="radio-inline">
                            <input type="radio" name="academic_position" value="2" required {{ $user->academic_position == '2' ? "checked":"" }}> Assoc. Prof.
                        </label>
                        <label class="radio-inline">
                            <input type="radio" name="academic_position" value="3" required {{ $user->academic_position == '3' ? "checked":"" }}> Asst. Prof.
                        </label>
                        <label class="radio-inline">
                            <input type="radio" name="academic_position" value="4" required {{ $user->academic_position == '4' ? "checked":"" }}> None
                        </label>
        ...
        <div class="form-group{{ $errors->has('name') || $errors->has('family_name') ? ' has-error' : '' }}">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="col-md-8">
                        <input id="family_name" type="text" class="form-control" name="family_name" value="{{ $user->family_name }}" required autofocus>
        ...
        <div class="form-group{{ $errors->has('affiliation') || $errors->has('country') ? ' has-error' : '' }}">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="col-md-8">
                        <input id="affiliation" type="affiliation" class="form-control" name="affiliation" value="{{ $user->affiliation }}" required>
        ...
        <div class="form-group{{ $errors->has('mobile') || $errors->has('fax') ? ' has-error' : '' }}">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="col-md-8">
                        <input id="mobile" type="mobile" class="form-control" name="mobile" value="{{ $user->mobile }}" required>
                ...
                <div class="col-md-6">
                    ...
                    <div class="col-md-8">
                        <input id="fax" type="fax" class="form-control" name="fax" value="{{ $user->fax }}">
