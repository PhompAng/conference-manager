                ...
                <tr>
                    ...
                    <td>
                        <form action="{{URL::route('user.destroy', ["conf" => $conf->id, "user"=>$user->id])}}" method="post">
                            {!! csrf_field() !!}
                            {!! method_field('DELETE') !!}
                            <a href="{{URL::route("user.show" , ["conf" => $conf->id, "user" => $user->id])}}" class="btn btn-default btn-xs" data-toggle="tooltip"  title="View">
                                <i class="fa fa-eye" aria-hidden="true"></i>
                            </a>
                            <a href="{{URL::route('user.edit', ["conf" => $conf->id, "user" => $user->id])}}" class="btn btn-default btn-xs" data-toggle="tooltip"  title="Edit">
