...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <p>The {{$conf->name}} Technical Program Committee has completed the reviewing process, and we are pleased to inform you that the paper named above has been <strong>{{$paper->decision}}</strong></p>
            @if($paper->decision == "Accepted")
                ...
                <ol>
                    <li>Please submit your manuscript paper (within 4-6 pages, PDF format) in the system before {{\App\Model\Conference::getFormattedDateTime($conf->camera_deadline)}}.</li>
                    <li>Please finish registration process before {{\App\Model\Conference::getFormattedDateTime($conf->pre_regis)}}.</li>
                </ol>
                <p>Please enter to the system by the following link.</p>
